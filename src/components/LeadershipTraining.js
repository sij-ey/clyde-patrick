    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300">
          Professional leadership, physiotherapy advocacy, clinical training,
          and continuous development in evidence-based rehabilitation practice.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto mt-14 space-y-10">
        ...
        >
          ...
          <p className="text-cyan-500 font-medium mt-1">
            Aga Khan University in Partnership with ATOM
          </p>
