  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* Intro */}
        <p className="mt-8 text-center text-gray-300 leading-relaxed text-lg">
        ...
        <p className="mt-6 text-center text-gray-300 leading-relaxed text-lg">
        ...
        <div className="mt-12 bg-gray-900 border border-cyan-500/20 rounded-2xl p-8 shadow-lg">
